<x-layouts::app :title="__('Modifier l\'écriture')">
    <div class="flex h-full w-full flex-1 flex-col gap-6">

        <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div>
                <h1 class="text-2xl font-semibold tracking-tight">Modifier l'écriture</h1>
                <p class="mt-1 text-sm text-neutral-500 dark:text-neutral-400">
                    {{ $journalEntry->entry_number }} — Brouillon
                </p>
            </div>
        </div>
        ...
        <form wire:submit="update" class="space-y-6">
                ...
                <div class="mt-5 space-y-5">
                    ...
                    <div class="grid gap-5 md:grid-cols-2">
                        <div>
                            ...
                            <input id="reference" type="text" wire:model="reference" class="w-full rounded-lg border border-neutral-300 px-3 py-2.5 text-sm dark:border-neutral-700 dark:bg-neutral-800">
            ...
            <div class="flex justify-end gap-3">
                ...
                <button type="submit" class="rounded-lg bg-neutral-900 px-4 py-2.5 text-sm font-medium text-white hover:bg-neutral-800 dark:bg-white dark:text-neutral-900">Enregistrer les modifications</button>
            </div>
