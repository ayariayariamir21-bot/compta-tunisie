<x-layouts::app :title="__('Nouveau devis')">
    <div class="flex h-full w-full flex-1 flex-col gap-6">
        ...
        <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div>
                <h1 class="text-2xl font-semibold tracking-tight">Nouveau devis</h1>
                <p class="mt-1 text-sm text-neutral-500 dark:text-neutral-400">Créez un nouveau devis pour un client.</p>
            </div>
        </div>

        <form wire:submit="store" class="max-w-5xl space-y-6">
                ...
                <div class="mt-5 space-y-5">
                    ...
                    <div>
                        ...
                        <textarea id="terms" wire:model="terms" rows="3"
                            class="w-full rounded-lg border border-neutral-300 px-3 py-2.5 text-sm dark:border-neutral-700 dark:bg-neutral-800"
                            placeholder="Conditions affichées sur le devis..."></textarea>
            ...
            <div class="flex justify-end gap-3">
                ...
                <button type="submit" wire:click="$set('saveAndSend', false)"
                    class="rounded-lg border border-neutral-300 px-4 py-2.5 text-sm font-medium hover:bg-neutral-50 dark:border-neutral-700 dark:hover:bg-neutral-800">
                    Enregistrer le brouillon
                </button>

                <button type="submit" wire:click="$set('saveAndSend', true)"
