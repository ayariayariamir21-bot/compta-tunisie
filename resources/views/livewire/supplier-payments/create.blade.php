<div class="space-y-6">
    <div class="flex items-center justify-between">
        <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Nouveau règlement fournisseur</h1>
        <a href="{{ route('supplier-payments.index') }}" class="text-sm text-flux-600 hover:text-flux-500 dark:text-flux-400" wire:navigate>Retour à la liste</a>
    </div>
    ...
    <div class="flux-card">
        ...
        <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
            <div>
                <flux:select wire:model.live="supplier_id" label="Fournisseur" placeholder="Sélectionner un fournisseur" required>
                    <option value="">—</option>
    ...
    <div class="flux-card">
        ...
        @if ($this->supplier_id === null)
            <p class="text-sm text-gray-500 dark:text-gray-400">Sélectionnez un fournisseur pour afficher ses factures ouvertes.</p>
    ...
    <div class="flex justify-end gap-3">
        ...
        <button wire:click="save(true)" wire:confirm="Voulez-vous créer et comptabiliser ce règlement ? Une écriture comptable sera générée." class="flux-btn-green">Enregistrer et comptabiliser</button>
    </div>
</div>
