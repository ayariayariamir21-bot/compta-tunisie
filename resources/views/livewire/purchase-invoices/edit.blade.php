    <div class="space-y-6">
        <div class="flex items-center justify-between">
            <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Modifier la facture fournisseur</h1>
        ...
        <form wire:submit="update" class="space-y-6">
            <div class="flux-card">
                ...
                <div class="grid grid-cols-1 gap-4 sm:grid-cols-3">
                    <div>
                        <flux:select wire:model="supplier_id" label="Fournisseur *" placeholder="Sélectionner un fournisseur">
