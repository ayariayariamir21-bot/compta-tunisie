<x-layouts::app :title="__('Nouveau fournisseur')">
        ...
        <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div>
                ...
                <p class="mt-1 text-sm text-neutral-500 dark:text-neutral-400">
                    Ajoutez un nouveau fournisseur à la société.
                </p>
            </div>
        </div>
            ...
            <div class="rounded-xl border border-neutral-200 bg-white p-6 shadow-sm dark:border-neutral-700 dark:bg-neutral-900">
                ...
                <div class="mt-5 space-y-5">
                    ...
                    <div class="grid gap-5 md:grid-cols-3">
                        ...
                        <div>
                            <label for="supplier_type" class="mb-1 block text-sm font-medium">Type de fournisseur *</label>
                            <select
                                id="supplier_type"
                ...
                <div class="mt-5 space-y-5">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            wire:model="website"
                            class="w-full rounded-lg border border-neutral-300 px-3 py-2.5 text-sm dark:border-neutral-700 dark:bg-neutral-800"
                            placeholder="https://www.fournisseur.tn"
                        >
                        @error('website')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
            ...
            <div class="rounded-xl border border-neutral-200 bg-white p-6 shadow-sm dark:border-neutral-700 dark:bg-neutral-900">
                ...
                <div class="mt-5 space-y-5">
                    ...
                    <div class="flex items-center gap-2">
                        ...
                        >
                        <label for="is_active" class="text-sm font-medium">Fournisseur actif</label>
                    </div>
