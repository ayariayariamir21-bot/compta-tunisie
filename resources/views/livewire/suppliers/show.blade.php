<x-layouts::app :title="__('Fournisseur : ' . $supplier->name)">
    <div class="flex h-full w-full flex-1 flex-col gap-6">
        ...
        <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div>
                ...
                <p class="mt-1 text-sm text-neutral-500 dark:text-neutral-400">
                    {{ $supplier->code }} — {{ $supplier->supplier_type->label() }}
                </p>
            </div>
                ...
                <dl class="mt-4 space-y-3">
                    ...
                    @if ($supplier->legal_name)
                        <div class="flex justify-between text-sm">
                            ...
                            <dd class="font-medium">{{ $supplier->legal_name }}</dd>
                        </div>
                    @endif
                    <div class="flex justify-between text-sm">
                        <dt class="text-neutral-500 dark:text-neutral-400">Type</dt>
                        <dd class="font-medium">{{ $supplier->supplier_type->label() }}</dd>
                    </div>
                </dl>
            </div>
            ...
            <div class="rounded-xl border border-neutral-200 bg-white p-6 shadow-sm dark:border-neutral-700 dark:bg-neutral-900">
                ...
                <dl class="mt-4 space-y-3">
                    <div class="flex justify-between text-sm">
                        ...
                        <dd class="font-medium">{{ $supplier->tax_identifier ?: '—' }}</dd>
                    </div>
                    <div class="flex justify-between text-sm">
                        <dt class="text-neutral-500 dark:text-neutral-400">RNE</dt>
                        <dd class="font-medium">{{ $supplier->rne ?: '—' }}</dd>
                    </div>
                </dl>
            </div>
            ...
            <div class="rounded-xl border border-neutral-200 bg-white p-6 shadow-sm dark:border-neutral-700 dark:bg-neutral-900">
                ...
                <dl class="mt-4 space-y-3">
                    <div class="flex justify-between text-sm">
                        ...
                        <dd class="font-medium text-right">{{ $supplier->address ?: '—' }}</dd>
                    </div>
                    <div class="flex justify-between text-sm">
                        <dt class="text-neutral-500 dark:text-neutral-400">Code postal</dt>
                        <dd class="font-medium">{{ $supplier->postal_code ?: '—' }}</dd>
                    </div>
                    <div class="flex justify-between text-sm">
                    ...
                    <div class="flex justify-between text-sm">
                        ...
                        <dd class="font-medium">{{ $supplier->governorate ?: '—' }}</dd>
                    </div>
                    <div class="flex justify-between text-sm">
                        <dt class="text-neutral-500 dark:text-neutral-400">Pays</dt>
                        <dd class="font-medium">{{ $supplier->country }}</dd>
                    </div>
                </dl>
            </div>
            ...
            <div class="rounded-xl border border-neutral-200 bg-white p-6 shadow-sm dark:border-neutral-700 dark:bg-neutral-900">
                ...
                <dl class="mt-4 space-y-3">
                    ...
                    <div class="flex justify-between text-sm">
                        ...
                        <dd class="font-medium">{{ $supplier->mobile ?: '—' }}</dd>
                    </div>
                    <div class="flex justify-between text-sm">
                    ...
                    <div class="flex justify-between text-sm">
                        ...
                        <dd class="font-medium">
                            @if ($supplier->website)
                                <a href="{{ $supplier->website }}" target="_blank" class="text-blue-600 hover:underline dark:text-blue-400">
                                    {{ $supplier->website }}
                                </a>
                            @else
                                —
            ...
            <div class="rounded-xl border border-neutral-200 bg-white p-6 shadow-sm dark:border-neutral-700 dark:bg-neutral-900">
                ...
                <dl class="mt-4 space-y-3">
                    <div class="flex justify-between text-sm">
                        ...
                        <dd class="font-medium">{{ $supplier->payment_terms_days }} jours</dd>
                    </div>
                    <div class="flex justify-between text-sm">
                        <dt class="text-neutral-500 dark:text-neutral-400">Limite de crédit</dt>
                        <dd class="font-medium">
                            {{ $supplier->credit_limit ? number_format((float) $supplier->credit_limit, 3, ',', '.') . ' TND' : '—' }}
                        </dd>
                    </div>
                    <div class="flex justify-between text-sm">
                        ...
                        <dd class="font-medium">
                            @if ($supplier->account)
                                {{ $supplier->account->code }} — {{ $supplier->account->name }}
                            @else
                                —
                            @endif
                        </dd>
        ...
        <div class="rounded-xl border border-dashed border-neutral-300 p-6 text-center dark:border-neutral-700">
            <h2 class="text-lg font-semibold text-neutral-400 dark:text-neutral-500">
                Factures d'achat, paiements et relevé de compte
            </h2>
            <p class="mt-2 text-sm text-neutral-400 dark:text-neutral-500">
                Ces sections seront disponibles lorsque les modules d'achats et de paiement seront implémentés.
            </p>
        </div>
