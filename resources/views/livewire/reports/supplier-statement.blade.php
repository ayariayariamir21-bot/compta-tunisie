    ...
    @else
        ...
        <div class="rounded-xl border border-neutral-200 bg-white p-4 shadow-sm dark:border-neutral-700 dark:bg-neutral-900">
            <div class="flex flex-col gap-3 sm:flex-row sm:items-end">
                <div class="flex-1">
                    <label for="supplierId" class="mb-1 block text-xs font-medium text-neutral-500 dark:text-neutral-400">Fournisseur</label>
                    <select
                        id="supplierId"
                    ...
                    >
                        ...
                        @foreach ($suppliers as $statementSupplier)
                            <option value="{{ $statementSupplier->id }}">
                                {{ $statementSupplier->code }} — {{ $statementSupplier->name }}@if(! $statementSupplier->is_active) (inactif) @endif
                            </option>
                        @endforeach
                    </select>
                </div>
        ...
        @if (! $supplier)
            <div class="rounded-xl border border-dashed border-neutral-300 p-10 text-center dark:border-neutral-700">
                ...
                <p class="mt-2 text-sm text-neutral-500 dark:text-neutral-400">
                    Choisissez un fournisseur pour afficher son relevé.
                </p>
            </div>
        ...
        @else
            ...
            <div class="flex justify-end">
                <flux:button
                    variant="outline"
                    href="{{ route('reports.supplier-statement.pdf', array_filter([
                ...
                <div class="flex flex-col gap-1 sm:flex-row sm:items-center sm:justify-between">
                    <div>
                        ...
                        <p class="text-sm text-neutral-500 dark:text-neutral-400">
                            Code : {{ $supplier->code }}
                            @if ($supplier->tax_identifier)
                                — Identifiant fiscal : {{ $supplier->tax_identifier }}
                            @endif
                        </p>
                    </div>
            ...
            <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 xl:grid-cols-4">
                ...
                <div class="rounded-xl border border-neutral-200 bg-white p-4 shadow-sm dark:border-neutral-700 dark:bg-neutral-900">
                    <p class="text-xs font-medium uppercase tracking-wider text-neutral-500 dark:text-neutral-400">Total crédits / Achats</p>
                    <p class="mt-1 text-lg font-semibold">{{ number_format((float) $statement['total_credit'], 3, ',', ' ') }}</p>
                </div>

                <div class="rounded-xl border border-neutral-200 bg-white p-4 shadow-sm dark:border-neutral-700 dark:bg-neutral-900">
                    <p class="text-xs font-medium uppercase tracking-wider text-neutral-500 dark:text-neutral-400">Total débits / Règlements</p>
                ...
                <div class="rounded-xl border border-neutral-200 bg-white p-4 shadow-sm dark:border-neutral-700 dark:bg-neutral-900">
                    ...
                    <p class="mt-1 text-xs text-neutral-500 dark:text-neutral-400">
                        ...
                        @endphp
                        @if ($closing > 0)
                            La société doit cette somme au fournisseur.
                        @elseif ($closing < 0)
                            Le fournisseur dispose d'un solde débiteur (trop-perçu).
                        @else
                            Compte soldé.
                        @endif
                    </p>
                    ...
                    <table class="min-w-full divide-y divide-neutral-200 dark:divide-neutral-700">
                        <thead class="bg-neutral-50 dark:bg-neutral-800">
                            <tr>
                                ...
                                <th class="px-4 py-2 text-left text-xs font-medium uppercase tracking-wider text-neutral-500 dark:text-neutral-400">N° facture fourn.</th>
                        ...
                        <tbody class="divide-y divide-neutral-200 dark:divide-neutral-700">
                            ...
                            @if ((float) $statement['opening_balance'] !== 0.0)
                                <tr class="bg-neutral-50 dark:bg-neutral-800/50">
                                    <td colspan="6" class="px-4 py-2 text-sm font-medium text-neutral-500 dark:text-neutral-400">
                                        Solde d'ouverture
                                    </td>
