    <div class="space-y-6">
        <div class="flex items-center justify-between">
            <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Modifier l'encaissement {{ $payment->payment_number }}</h1>
            <a href="{{ route('customer-payments.show', $payment->id) }}" class="text-sm text-flux-600 hover:text-flux-500 dark:text-flux-400" wire:navigate>Retour au détail</a>
        </div>
        ...
        <div class="flux-card">
            ...
            <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
                <div>
                    <flux:input label="Client" :value="$payment->customer?->name" disabled />
                </div>
                <div>
        ...
        <div class="flex justify-end gap-3">
            ...
            <button wire:click="save(true)" wire:confirm="Voulez-vous enregistrer et comptabiliser cet encaissement ? Une écriture comptable sera générée." class="flux-btn-green">Enregistrer et comptabiliser</button>
        </div>
    </div>
