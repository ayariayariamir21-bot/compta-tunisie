...
class Edit extends Component
{
    ...
    public function mount(int $purchaseInvoiceId): void
    {
        ...
        $this->invoice_date = $purchaseInvoice->invoice_date->toDateString();
        $this->due_date = $purchaseInvoice->due_date?->toDateString();
        $this->supplier_invoice_number = $purchaseInvoice->supplier_invoice_number;
        $this->currency = $purchaseInvoice->currency;
        $this->journal_id = $purchaseInvoice->journal_id;
        $this->payment_terms_days = $purchaseInvoice->payment_terms_days;
        $this->notes = $purchaseInvoice->notes;
    ...
    public function update(PurchaseInvoiceService $purchaseInvoiceService, CurrentCompany $currentCompany): void
    {
        ...
        $purchaseInvoice = PurchaseInvoice::findOrFail($this->purchaseInvoiceId);
        ...
        try {
            $purchaseInvoiceService->updateDraft($purchaseInvoice, $validated);
        ...
        session()->flash('success', "La facture fournisseur « {$purchaseInvoice->invoice_number} » a été modifiée.");
