...
class Edit extends Component
{
    ...
    public function mount(int $invoiceId): void
    {
        ...
        $this->journal_id = $invoice->journal_id;
        $this->payment_terms_days = $invoice->payment_terms_days;
    ...
    public function update(InvoiceService $invoiceService, CurrentCompany $currentCompany): void
    {
        ...
        try {
            $invoiceService->updateDraft($invoice, $validated);
        ...
        session()->flash('success', "La facture « {$invoice->invoice_number} » a été modifiée.");
